...
def eiou_loss_ct(pred,
    ...
    focal_eiou_loss = (1 - ious + rho2/c2 + rhow / cw**2 + rhoh / ch**2)
    res = torch.sum(focal_eiou_loss * weight)[None] / avg_factor
    return res

def giou_loss_ct(pred,
              target,
              mask,
              avg_factor=None):
    """GIoU loss.
    ...
    res = torch.sum(iou_distances * weight)[None] / avg_factor
    return res
