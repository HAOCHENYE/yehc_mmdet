...
class TTFHead_multi_backend(AnchorHead):
    ...
    def __init__(self,
        ...
        # heads
        self.wh_large = self.build_head(self.wh_planes, wh_head_conv_num, wh_conv)
        self.wh_little = self.build_head(self.wh_planes, wh_head_conv_num, wh_conv)
        self.hm_large = self.build_head(self.num_fg, hm_head_conv_num)
        self.hm_little = self.build_head(self.num_fg, hm_head_conv_num)
    ...
    def loss_calc(self,
        ...
        hm_loss = 1*(ct_focal_loss(pred_hm_large, heatmap_large) * self.hm_weight+ct_focal_loss(pred_hm_little, heatmap_little))
