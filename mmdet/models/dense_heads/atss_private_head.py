...
class ATSSPrivateHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(ATSSPrivateHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _init_layers(self):
        ...
        for level in range(self.num_out):
            ...
            atss_centerness = nn.Conv2d(
                self.feat_channels, self.num_anchors * 1, 1, padding=0)
    ...
    def init_weights(self):
        ...
        for level in range(self.num_out):
            ...
            normal_init(self.mlvl_atss_centerness_convs[level], std=0.01)
    ...
    def forward_single(self, x, scale, level, onnx=False):
        ...
        centerness = self.mlvl_atss_centerness_convs[level](reg_feat)
        if onnx==True:
            return F.sigmoid(cls_score)*F.sigmoid(centerness), bbox_pred
