...
from mmdet.models.dense_heads import ATSSPrivateHead
EPS = 1e-12
try:
...
class PAAPrivateHead(ATSSPrivateHead):
    ...
    def __init__(self,
        ...
        super(PAAPrivateHead, self).__init__(*args, **kwargs)
    ...
    def _get_targets_single(self,
        ...
        return super(ATSSPrivateHead, self)._get_targets_single(
            flat_anchors,
            valid_flags,
            gt_bboxes,
            gt_bboxes_ignore,
