...
work_dir = 'work_dirs/vfnet_paa_CSPOSA_yefpn_coco_paareaasign_focal_focal'
load_from = None
resume_from = 'work_dirs/vfnet_paa_CSPOSA_yefpn_coco_paareaasign_focal_focal/latest.pth'
# resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 2)
pdb_debug=True